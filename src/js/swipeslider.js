  ...
  $.fn.swipeslider = function (options) {
    ...
    */
    function swiping(event) {
      ...
      var shangxaiSlide = pointerData.clientY - startClientY;

      //防止左右滑动和上下滑动冲突
      if(deltaSlide > 50 || shangxaiSlide > 50){
        if(deltaSlide > shangxaiSlide){
          //左右
          judgeSlidePosition = 1;
        }else{
          //上下
          judgeSlidePosition = 0;
        }
      }
